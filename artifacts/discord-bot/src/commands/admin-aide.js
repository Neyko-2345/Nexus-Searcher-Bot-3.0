...
const FAQ = [
  ...
  {
    keywords: ['vip', 'plan', 'crédits', 'crédit', 'accès', 'rôle', 'limite', 'gratuit', 'unlimited', 'illimité', 'abonnement', 'expiration', 'durée', 'timer', 'rappel', 'revoke', 'subs'],
    title: '💳 Plans VIP, Crédits & Abonnements',
    answer: [
      ...
      '```',
      '• `duree` *(facultatif)* — durée en jours avant expiration auto. Sans durée = permanent.',
      '',
      '**Appliquer un plan à un utilisateur :**',
      '`/plan apply user:@Dupont role:@Premium`',
      '→ Attribue le rôle + crée le timer si le plan a une durée + DM de confirmation.',
      '',
      '**Système d\'abonnement automatique (si `duree` est définie) :**',
      '• 🟡 DM rappel **1 jour avant** expiration',
      '• 🔴 DM rappel **5 min avant** expiration',
      '• ❌ À l\'expiration : rôle retiré, plan remis à zéro, DM envoyé',
      '',
      '**Gérer les abonnements :**',
      '`/plan subs user:@Dupont` → voir les abonnements actifs + dates d\'expiration',
      '`/plan revoke user:@Dupont role:@Premium` → révoquer manuellement',
      '',
